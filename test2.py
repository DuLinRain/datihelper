...
def screenshot():
    ...
    newbuffer = cStringIO.StringIO()
    im.save(newbuffer, format="jpeg")
    im_data = newbuffer.getvalue()
    image = 'data:image/jpeg;base64,' + im_data
    # print data_url;
    # print get_file_content(PATH(path + "/" + timestamp + "dd.jpeg"));
